...
if (isset($_GET['name'], $_GET['quantity'], $_GET['cellphone'], $_GET['address'], $_GET['payment'], $_GET['flowerName'])) {
    ...
    if ($flowerName === 'Casia nodosa') {
        $flowerPrice = 200;
        $driverName = "Mark Tamayo";
        $driverPlateNumber = "NIG 645";
    } elseif ($flowerName === 'Indian laurel') {
        $flowerPrice = 300;
        $driverName = "Seb Cayanan";
        $driverPlateNumber = "BIT 113";
    } elseif ($flowerName === 'Rubber tree') {
        $flowerPrice = 250;
        $driverName = "Jed Mirabueno";
