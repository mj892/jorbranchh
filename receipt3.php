...
if (isset($_GET['name'], $_GET['quantity'], $_GET['cellphone'], $_GET['address'], $_GET['payment'], $_GET['flowerName'])) {
    ...
    echo "<p><strong>Flower Name:</strong> $flowerName</p>";
    echo "<p><strong>Flower Price:</strong> Php $flowerPrice</p>"; 
